...
enum class IntSetting(
    ...
    GRAPHICS_API("graphics_api", Settings.SECTION_RENDERER, 2),
    ...
    SCREEN_LAYOUT("layout_option", Settings.SECTION_LAYOUT, 5),
    SMALL_SCREEN_POSITION("small_screen_position",Settings.SECTION_LAYOUT,7),
    LANDSCAPE_TOP_X("custom_top_x",Settings.SECTION_LAYOUT,7),
    LANDSCAPE_TOP_Y("custom_top_y",Settings.SECTION_LAYOUT,7),
    LANDSCAPE_TOP_WIDTH("custom_top_width",Settings.SECTION_LAYOUT,705),
    LANDSCAPE_TOP_HEIGHT("custom_top_height",Settings.SECTION_LAYOUT,423),
    LANDSCAPE_BOTTOM_X("custom_bottom_x",Settings.SECTION_LAYOUT,172),
    LANDSCAPE_BOTTOM_Y("custom_bottom_y",Settings.SECTION_LAYOUT,438),
    LANDSCAPE_BOTTOM_WIDTH("custom_bottom_width",Settings.SECTION_LAYOUT,375),
    LANDSCAPE_BOTTOM_HEIGHT("custom_bottom_height",Settings.SECTION_LAYOUT,281),
